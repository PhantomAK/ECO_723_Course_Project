...
Credit Card Fraud Detection using HOBA Feature Engineering 
...
891 engineered variables

Exploratory Data Analysis

Several fraud patterns emerged during EDA:
...
Since fraud detection is an imbalanced classification problem, multiple evaluation metrics were used:
...
These metrics better capture real-world fraud detection performance than accuracy alone.
